                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"#ffc72c"} aria-hidden="true" aria-label="Chat logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Chat with McDonald's Copilot</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>
                                McDonald's Copilot remembers your conversation history and answers questions in that context
                            </h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. Vilka ingredienser finns i en Big Mac?)"
                            disabled={isLoading}
